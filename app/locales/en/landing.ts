export default {
  ...
  fluencyDescription:
    "Enjoy a simple, elegant interface that turns reading excerpts into an engaging language learning experience.",
  spotlightImmersive: {
  ...
  spotlightInteractive: {
    ...
    description:
      "Answer quick questions to reinforce your vocabulary and grammar.",
  },
  spotlightExperience: {
